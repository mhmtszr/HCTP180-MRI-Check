...
export const MainPageIconOutline = (style: StyleProp<ImageStyle>): IconElement => {
  const source: IconSource = {
    imageSource: require('./eva/128/home-outline.png'),
  };

  return Icon(source, style);
};

export const ActivityIconOutline = (style: StyleProp<ImageStyle>): IconElement => {
  const source: IconSource = {
    imageSource: require('./eva/128/activity-outline.png'),
  };

  return Icon(source, style);
};

export const MessageIconOutline = (style: StyleProp<ImageStyle>): IconElement => {
  const source: IconSource = {
    imageSource: require('./eva/128/message-circle-outline.png'),
  };

  return Icon(source, style);
};

export const ClockIconOutlineOrange = (style: StyleProp<ImageStyle>): IconElement => {
  const source: IconSource = {
    imageSource: require('./eva/128/clock-outline-orange.png'),
  };

  return Icon(source, style);
};

export const ClipboardIconOutlineOrange = (style: StyleProp<ImageStyle>): IconElement => {
  const source: IconSource = {
    imageSource: require('./eva/128/clipboard-outline-orange.png'),
  };

  return Icon(source, style);
};

export const CheckmarkIconOutlineOrange = (style: StyleProp<ImageStyle>): IconElement => {
  const source: IconSource = {
    imageSource: require('./eva/128/checkmark-circle-outline-orange.png'),
  };

  return Icon(source, style);
};

export const CalendarIconOutlineOrange = (style: StyleProp<ImageStyle>): IconElement => {
  const source: IconSource = {
    imageSource: require('./eva/128/calendar-outline-orange.png'),
  };
...
export const SettingsIconOutline = (style: StyleProp<ImageStyle>): IconElement => {
  const source: IconSource = {
    imageSource: require('./eva/128/settings-outline.png'),
  };
