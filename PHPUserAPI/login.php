...
$query = $db->query("SELECT * FROM users WHERE phone = '{$phone}' AND pass = '{$pass}'")->fetch(PDO::FETCH_ASSOC);
if ($query){
    $token = hash('sha256', $phone."ODTUIEE<3".$time."<3".$pass."HCTP180"); //User Token oluşturduk.
